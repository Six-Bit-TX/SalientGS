...
class Points3D:
    ...
    # List[List[Tuple[float, float]]], a list of length `num_points`, each element is a list of (x, y) pixel coordinates for keypoints in the track
    track_xy_pixels: List[List[Tuple[float, float]]]
